...
Go Stack 11: Respositório criado a partir do template do desafio de fundamentos de React JS com typescript do bootcamp da Rocketseat. O objetivo deste repositório é simplesmente entregar o desafio proposto durante o treinamento, a partir do link do mesmo.
...
Essa será uma aplicação que irá se conectar ao seu backend do [Desafio 06](https://github.com/jb9dev/desafio_database_upload), e exibir as transações criadas e permitir a importação de um arquivo CSV para gerar novos registros no banco de dados.
